...
public class PlayerStats
{
    ...
    // Returns all the "live" data at once (instead of having to recalculate portfolio value each time)
    ...
    public static int MaxBuyableQuantity(Player player, Commodity commodity)
    {
        var cost = 0.0;
        var quantity = 0;
        while (cost+commodity.Price<=player.Cash)
        {
